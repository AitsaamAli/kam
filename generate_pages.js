...
[data-theme="light"]{--bg:#fff;--bg2:#F8F9FA;--bd:#E2E8F0;--tx:#0F172A;--tx2:#334155;--tx3:#64748B;--sh:0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)}
[data-theme="dark"]{--bg:#0A0F1E;--bg2:#0F172A;--bd:rgba(255,255,255,.08);--tx:#F1F5F9;--tx2:#CBD5E1;--tx3:#64748B;--sh:0 1px 3px rgba(0,0,0,.4),0 4px 16px rgba(0,0,0,.3)}
...
.topbar{background:#0F172A;border-bottom:1px solid rgba(255,255,255,.2);padding:9px 0}
...
.breadcrumb a{color:#94A3B8}.breadcrumb a:hover{color:#14B8A6}.breadcrumb i{font-size:.55rem}
...
.article h2{font-family:var(--fs);font-size:1.65rem;font-weight:600;color:#0F172A;margin:40px 0 16px;display:flex;align-items:center;gap:12px}
...
table.dt td{padding:13px 16px;color:#334155}
...
.fq-q i{color:#14B8A6;transition:transform .3s;flex-shrink:0}
...
.btn-g{background:transparent;color:#fff;padding:11px 26px;border-radius:8px;font-size:.88rem;display:inline-flex;align-items:center;gap:8px;border:1.5px solid rgba(255,255,255,.4);text-decoration:none}
...
.rl a{display:flex;align-items:center;gap:8px;padding:8px 10px;border-radius:7px;font-size:.84rem;color:#64748B;transition:all .2s}
...
.flr a{color:#64748B;font-size:.85rem}
...
const NAV_HTML = `<div class="topbar"><div class="container"><div class="topbar-left"><div class="topbar-promo-wrap"><span class="topbar-promo">File Your Taxes In Just 6 Minutes With Our Qualified Consultants! &nbsp;&bull;&nbsp; Now Available in Just Rs. 3,500/- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="topbar-promo" aria-hidden="true">File Your Taxes In Just 6 Minutes With Our Qualified Consultants! &nbsp;&bull;&nbsp; Now Available in Just Rs. 3,500/- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div></div></div></div>
<nav class="navbar" id="navbar"><div class="container"><a href="/" class="logo"><div><svg width="44" height="44" viewBox="0 0 46 46" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="lg1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#1a3a1a"/><stop offset="100%" stop-color="#0d2a0d"/></linearGradient><linearGradient id="lg2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#F0CF6B"/><stop offset="100%" stop-color="#D4AF37"/></linearGradient></defs><circle cx="23" cy="23" r="23" fill="url(#lg1)"/><circle cx="23" cy="23" r="21" fill="none" stroke="url(#lg2)" stroke-width="1.5"/><text x="23" y="27" font-family="Cinzel,serif" font-size="13" font-weight="700" fill="url(#lg2)" text-anchor="middle" letter-spacing="1">KA</text></svg></div><div><div class="logo-name">KAMBOH ASSOCIATES</div><div class="logo-sub">Tax &amp; Regulatory Excellence</div></div></a><ul class="nav-links"><li><a href="/">Home</a></li><li><a href="/income-tax-filing">Services</a></li><li><a href="/pricing">Pricing</a></li><li><a href="/blogs" class="active">Blog</a></li><li><a href="/contact">Contact</a></li></ul><div class="nav-actions"><span class="nav-phone"><i class="fas fa-phone"></i><a href="tel:03284675162">0328-4675162</a></span><a href="/contact" class="nav-cta">Get Started</a><button class="hamburger" id="hamburger" onclick="this.classList.toggle('open');document.getElementById('mobileNav').classList.toggle('open')" aria-label="Menu"><span></span><span></span><span></span></button></div></div><div class="mobile-nav" id="mobileNav"><a href="/">Home</a><a href="/income-tax-filing">Services</a><a href="/pricing">Pricing</a><a href="/blogs">Blog</a><a href="/contact">Contact</a><a href="https://wa.me/923284675162" target="_blank" style="color:#25D366"><i class="fab fa-whatsapp" style="margin-right:8px"></i>WhatsApp</a></div></nav>`;

const FOOTER_HTML = `<footer><div class="container"><div class="fl">KAMBOH ASSOCIATES</div><p style="font-size:.82rem;color:#64748B;margin-bottom:8px">Tax &amp; Regulatory Excellence &mdash; Serving Pakistan Nationwide</p><div class="flr"><a href="/">Home</a><a href="/#services">Services</a><a href="/blogs">Blog</a><a href="/contact">Contact</a><a href="https://wa.me/923284675162" target="_blank">WhatsApp</a></div><div style="font-size:.78rem;margin-top:8px">&copy; 2026 Kamboh Associates. All rights reserved. | <a href="tel:03284675162" style="color:#D4AF37">0328-4675162</a></div></div></footer>`;

const WA_BTN = `<a href="https://wa.me/923284675162?text=Hello%20Kamboh%20Associates%2C%20I%20need%20tax%20consultation." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" class="wa-float"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="#fff"><path d="M16 0C7.163 0 0 7.163 0 16c0 2.822.736 5.476 2.027 7.785L0 32l8.469-2.001A15.93 15.93 0 0016 32c8.837 0 16-7.163 16-16S24.837 0 16 0zm0 29.333a13.27 13.27 0 01-6.77-1.855l-.485-.288-5.024 1.188 1.228-4.893-.317-.502A13.267 13.267 0 012.667 16C2.667 8.636 8.636 2.667 16 2.667S29.333 8.636 29.333 16 23.364 29.333 16 29.333zm7.27-9.862c-.398-.199-2.354-1.162-2.72-1.294-.365-.133-.631-.199-.897.199-.265.398-1.029 1.294-1.261 1.56-.232.265-.465.299-.863.1-.398-.199-1.681-.619-3.202-1.977-1.183-1.057-1.981-2.362-2.213-2.76-.232-.398-.025-.613.175-.811.179-.179.398-.465.597-.698.199-.232.265-.398.398-.664.133-.265.066-.498-.033-.697-.1-.199-.897-2.163-1.229-2.96-.324-.777-.653-.672-.897-.684l-.764-.013c-.265 0-.697.1-1.062.498-.365.398-1.394 1.362-1.394 3.322s1.428 3.853 1.627 4.119c.199.265 2.808 4.287 6.804 6.014.951.411 1.693.656 2.271.84.954.304 1.823.261 2.509.158.765-.114 2.354-.962 2.686-1.891.333-.929.333-1.726.233-1.891-.1-.165-.365-.265-.764-.464z"/></svg></a>`;
...
var ro=new IntersectionObserver(function(e){e.forEach(function(x){if(x.isIntersecting){x.target.classList.add('visible');ro.unobserve(x.target);}});},{threshold:0});
...
function makeTCPage(slug) {
  const loc = slugToTitle(slug.replace('tax-consultant-',''));
  const url = `https://kambohassociates.com/blogs/${slug}`;
  const waMsg = `Hi%2C+I+need+tax+help+in+${loc.replace(/ /g,'+')}`;
  return `<!DOCTYPE html>
<html lang="en" data-theme="light">
<head>
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large"/>
<meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
<title>Best Tax Consultant in ${loc} | Kamboh Associates</title>
<meta name="description" content="Top tax consultant in ${loc}. NTN registration, income tax filing, FBR compliance — affordable, remote, expert service. WhatsApp: 0328-4675162."/>
<meta name="geo.placename" content="${loc}"/>
<meta property="og:type" content="article"/><meta property="og:title" content="Best Tax Consultant in ${loc}"/><meta property="og:url" content="${url}"/>
<link rel="canonical" href="${url}"/>
${HEAD_COMMON}
<script type="application/ld+json">[{"@context":"https://schema.org","@type":"Article","headline":"Best Tax Consultant in ${loc}","datePublished":"2026-07-17","author":{"@type":"Organization","name":"Kamboh Associates"}},{"@context":"https://schema.org","@type":"LocalBusiness","name":"Kamboh Associates","address":{"@type":"PostalAddress","addressLocality":"${loc}","addressCountry":"PK"},"telephone":"+923284675162","url":"https://kambohassociates.com","areaServed":"${loc}","priceRange":"Rs 3,500+"},{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://kambohassociates.com/"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://kambohassociates.com/blogs"},{"@type":"ListItem","position":3,"name":"Tax Consultant in ${loc}","item":"${url}"}]}]<\/script>
${CSS}
</head>
<body>
${NAV_HTML}
<section class="hero"><div class="container">
  <div class="breadcrumb"><a href="/"><i class="fas fa-home"></i> Home</a><i class="fas fa-chevron-right"></i><a href="/blogs">Blog</a><i class="fas fa-chevron-right"></i><span>Tax Consultant in ${loc}</span></div>
  <div class="badge"><i class="fas fa-map-marker-alt"></i> Local Tax Guide</div>
  <h1>Best Tax Consultant in ${loc}</h1>
  <div class="hero-meta"><div class="meta-item"><i class="far fa-calendar-alt"></i> July 2026</div><div class="meta-item"><i class="fas fa-user-tie"></i> Kamboh Associates</div><div class="meta-item"><i class="far fa-clock"></i> 6 min read</div><div class="meta-item"><i class="fas fa-map-pin"></i> ${loc}</div></div>
</div></section>
<div class="container"><div class="layout">
<article><div class="article reveal">
  <p class="lead">Kamboh Associates provides expert FBR tax and compliance services to all residents and businesses in ${loc}. Whether you need <a href="/ntn-registration">NTN registration</a>, income tax filing, <a href="/wealth-statement">wealth statement</a>, or help responding to <a href="/fbr-notice-defense">FBR notices</a> — our qualified consultants handle everything remotely. No office visit required. WhatsApp your documents to 0328-4675162 and we begin immediately.</p>
  <h2 id="why">Why ${loc} Taxpayers Need a Tax Consultant in 2026</h2>
  ...
  <div class="ib"><i class="fas fa-lightbulb"></i><p><strong>Key Benefit for ${loc} Residents:</strong> Being a tax filer saves significant money on every major financial transaction. Property purchases, vehicle registration, banking, and utilities all carry 50% lower withholding tax for ATL filers. Annual filing costs just Rs 3,500 — the annual savings can be Rs 50,000 to Rs 500,000+.</p></div>
  <h2 id="services">Our Services for ${loc} Clients</h2>
  <ul>
  ...
  <h2 id="benefits">Benefits of Being a Tax Filer</h2>
  <div class="ig">
    <div class="ic"><div class="lb">Property Purchase</div><div class="vl">3% vs 6%</div><div class="sb">Filer vs non-filer WHT</div></div>
    <div class="ic"><div class="lb">Vehicle Token Tax</div><div class="vl">50% Less</div><div class="sb">For ATL filers</div></div>
  ...
  <ol>
    ...
    <li><strong>NTN registration</strong> completed within 24–48 business hours if needed</li>
  ...
  <table class="dt"><thead><tr><th>Service</th><th>Starting Price</th><th>Timeline</th></tr></thead><tbody>
  ...
  <div class="cta-box">
    <h3>Get Expert Tax Help in ${loc} Today</h3>
    <p>Kamboh Associates serves all ${loc} clients remotely. Share your documents via WhatsApp and we handle everything — free first consultation.</p>
    <div class="cta-btns">
      <a href="https://wa.me/923284675162?text=${waMsg}" class="btn-w" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> Free Consultation</a>
      <a href="tel:03284675162" class="btn-g"><i class="fas fa-phone"></i> 0328-4675162</a>
    </div>
  </div>
  <h2 id="faqs">Frequently Asked Questions</h2>
  <div class="fq">
    <div class="fi"><div class="fq-q">Who needs to file income tax in ${loc}? <i class="fas fa-plus"></i></div><div class="fq-a">Any individual in ${loc} earning above Rs 600,000 per year from salary, business, rental income, or freelancing must file an annual income tax return with FBR by September 30 each year.</div></div>
    ...
    <div class="fi"><div class="fq-q">Do I need to visit your office? <i class="fas fa-plus"></i></div><div class="fq-a">No. We serve all ${loc} clients completely remotely. Simply WhatsApp your documents to 0328-4675162 and we complete your entire tax filing online. No office visit is required at any stage.</div></div>
    <div class="fi"><div class="fq-q">What is the income tax return deadline? <i class="fas fa-plus"></i></div><div class="fq-a">The annual income tax return deadline is September 30 each year. Late filing attracts penalties of 5% of tax payable per month. File before August 31 to avoid last-minute issues.</div></div>
    <div class="fi"><div class="fq-q">How quickly can you register my NTN? <i class="fas fa-plus"></i></div><div class="fq-a">Kamboh Associates completes NTN registration within 24 to 48 business hours. WhatsApp your CNIC copy and basic details and we begin immediately.</div></div>
  </div>
</div></article>
<aside class="sidebar">
  <div class="sc reveal"><div class="st"><i class="fas fa-list"></i> Contents</div><nav class="rl"><a href="#why"><i class="fas fa-circle"></i> Why It Matters</a><a href="#services"><i class="fas fa-circle"></i> Our Services</a><a href="#benefits"><i class="fas fa-circle"></i> Filer Benefits</a><a href="#process"><i class="fas fa-circle"></i> How to Start</a><a href="#pricing"><i class="fas fa-circle"></i> Pricing</a><a href="#faqs"><i class="fas fa-circle"></i> FAQs</a></nav></div>
  <div class="sc cc reveal" style="transition-delay:.1s"><h3>Tax Help in ${loc}</h3><p>Expert FBR compliance from Kamboh Associates. First consultation free.</p><a href="https://wa.me/923284675162" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> WhatsApp Now</a></div>
...
function makeNTNPage(slug) {
  const city = slugToTitle(slug.replace('ntn-registration-',''));
  const url = `https://kambohassociates.com/blogs/${slug}`;
  const waMsg = `Hi%2C+I+need+NTN+registration+in+${city.replace(/ /g,'+')}`;
  return `<!DOCTYPE html>
<html lang="en" data-theme="light">
<head>
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large"/>
<meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
<title>NTN Registration in ${city} | Online FBR 2026 | Kamboh Associates</title>
<meta name="description" content="NTN registration in ${city} — online, fast, just Rs 1,500. FBR IRIS application completed in 24-48 hours. WhatsApp 0328-4675162."/>
<meta name="geo.placename" content="${city}"/>
<meta property="og:type" content="article"/><meta property="og:title" content="NTN Registration in ${city}"/><meta property="og:url" content="${url}"/>
<link rel="canonical" href="${url}"/>
${HEAD_COMMON}
<script type="application/ld+json">[{"@context":"https://schema.org","@type":"Article","headline":"NTN Registration in ${city}","datePublished":"2026-07-17","author":{"@type":"Organization","name":"Kamboh Associates"}},{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://kambohassociates.com/"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://kambohassociates.com/blogs"},{"@type":"ListItem","position":3,"name":"NTN Registration in ${city}","item":"${url}"}]}]<\/script>
${CSS}
</head>
<body>
${NAV_HTML}
<section class="hero"><div class="container">
  ...
  <div class="hero-meta"><div class="meta-item"><i class="far fa-calendar-alt"></i> July 2026</div><div class="meta-item"><i class="fas fa-user-tie"></i> Kamboh Associates</div><div class="meta-item"><i class="far fa-clock"></i> 5 min read</div><div class="meta-item"><i class="fas fa-map-pin"></i> ${city}</div></div>
</div></section>
<div class="container"><div class="layout">
<article><div class="article reveal">
  ...
  <ol>
    ...
    <li><strong>OTP verification</strong> — we guide you through the process</li>
    <li><strong>NTN issued</strong> — you receive your number within 24–48 hours</li>
    <li><strong>Tax return filing</strong> — we recommend filing immediately to get ATL status</li>
  </ol>
  <h2 id="pricing">NTN Registration Fees in ${city}</h2>
  <table class="dt"><thead><tr><th>Service</th><th>Price</th><th>Timeline</th></tr></thead><tbody>
  ...
  <div class="cta-box">
    ...
    <div class="cta-btns">
      <a href="https://wa.me/923284675162?text=${waMsg}" class="btn-w" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> WhatsApp Now</a>
      <a href="tel:03284675162" class="btn-g"><i class="fas fa-phone"></i> 0328-4675162</a>
    </div>
  </div>
  <h2 id="faqs">Frequently Asked Questions</h2>
  <div class="fq">
    <div class="fi"><div class="fq-q">How long does NTN registration take in ${city}? <i class="fas fa-plus"></i></div><div class="fq-a">Kamboh Associates completes NTN registration for ${city} clients within 24 to 48 business hours. Simply WhatsApp your CNIC copy and we begin immediately.</div></div>
    <div class="fi"><div class="fq-q">What documents do I need for NTN registration? <i class="fas fa-plus"></i></div><div class="fq-a">You need your CNIC (front and back), a phone number registered on your CNIC, and an email address. For businesses, you also need the business name, address, and type.</div></div>
    <div class="fi"><div class="fq-q">Is NTN registration free in Pakistan? <i class="fas fa-plus"></i></div><div class="fq-a">FBR does not charge for NTN registration. The Rs 1,500 is Kamboh Associates professional service fee — we handle the complete process saving you time and errors on FBR IRIS.</div></div>
    <div class="fi"><div class="fq-q">Can I get NTN online without visiting FBR office? <i class="fas fa-plus"></i></div><div class="fq-a">Yes. NTN registration is fully online through FBR IRIS. We complete the entire process remotely for ${city} clients — no FBR office visit required at any stage.</div></div>
  </div>
</div></article>
<aside class="sidebar">
  <div class="sc reveal"><div class="st"><i class="fas fa-list"></i> Contents</div><nav class="rl"><a href="#what"><i class="fas fa-circle"></i> What is NTN?</a><a href="#docs"><i class="fas fa-circle"></i> Documents</a><a href="#process"><i class="fas fa-circle"></i> Steps</a><a href="#pricing"><i class="fas fa-circle"></i> Fees</a><a href="#faqs"><i class="fas fa-circle"></i> FAQs</a></nav></div>
  <div class="sc cc reveal" style="transition-delay:.1s"><h3>NTN Registration ${city}</h3><p>24–48 hour turnaround. Rs 1,500 only. Fully remote service.</p><a href="https://wa.me/923284675162" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> WhatsApp Now</a></div>
...
function makeITFPage(slug) {
  const city = slugToTitle(slug.replace('income-tax-filing-',''));
  const url = `https://kambohassociates.com/blogs/${slug}`;
  const waMsg = `Hi%2C+I+need+income+tax+filing+in+${city.replace(/ /g,'+')}`;
  return `<!DOCTYPE html>
<html lang="en" data-theme="light">
<head>
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large"/>
<meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
<title>Income Tax Filing in ${city} | FBR Return 2026 | Kamboh Associates</title>
<meta name="description" content="Online income tax return filing in ${city}. Expert FBR compliance from Rs 3,500. Salaried, business, freelancers — fully remote. WhatsApp 0328-4675162."/>
<meta name="geo.placename" content="${city}"/>
<meta property="og:type" content="article"/><meta property="og:title" content="Income Tax Filing in ${city}"/><meta property="og:url" content="${url}"/>
<link rel="canonical" href="${url}"/>
${HEAD_COMMON}
<script type="application/ld+json">[{"@context":"https://schema.org","@type":"Article","headline":"Income Tax Filing in ${city}","datePublished":"2026-07-17","author":{"@type":"Organization","name":"Kamboh Associates"}},{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://kambohassociates.com/"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://kambohassociates.com/blogs"},{"@type":"ListItem","position":3,"name":"Income Tax Filing in ${city}","item":"${url}"}]}]<\/script>
${CSS}
</head>
<body>
${NAV_HTML}
<section class="hero"><div class="container">
  ...
  <div class="hero-meta"><div class="meta-item"><i class="far fa-calendar-alt"></i> July 2026</div><div class="meta-item"><i class="fas fa-user-tie"></i> Kamboh Associates</div><div class="meta-item"><i class="far fa-clock"></i> 6 min read</div><div class="meta-item"><i class="fas fa-map-pin"></i> ${city}</div></div>
</div></section>
<div class="container"><div class="layout">
<article><div class="article reveal">
  ...
  <div class="ib"><i class="fas fa-lightbulb"></i><p><strong>Deadline:</strong> The income tax return deadline is September 30 each year. Filing before this date avoids late filing penalties. Kamboh Associates recommends filing before August 31 to ensure on-time submission.</p></div>
  ...
  <ol>
    ...
    <li><strong>Share income documents</strong> — salary slips, bank statements, rental proof</li>
  ...
  <table class="dt"><thead><tr><th>Category</th><th>Starting Price</th><th>Timeline</th></tr></thead><tbody>
  ...
  <div class="fq">
    ...
    <div class="fi"><div class="fq-q">What documents are needed to file tax return? <i class="fas fa-plus"></i></div><div class="fq-a">For salaried: salary slips or Form 16, CNIC. For business: accounts/bookkeeping records. For property: sale/purchase agreements, rental income proof.</div></div>
    <div class="fi"><div class="fq-q">Can I file tax return without visiting your office? <i class="fas fa-plus"></i></div><div class="fq-a">Yes — we serve all ${city} clients fully remotely. Simply WhatsApp your documents to 0328-4675162 and we prepare and file your complete return online.</div></div>
    <div class="fi"><div class="fq-q">What happens if I don't file income tax return? <i class="fas fa-plus"></i></div><div class="fq-a">Non-filers face higher withholding tax rates (double on property, vehicles, bank transactions), cannot purchase property above Rs 5 crore, and may receive FBR notices requiring filing under penalty.</div></div>
  </div>
</div></article>
<aside class="sidebar">
  <div class="sc reveal"><div class="st"><i class="fas fa-list"></i> Contents</div><nav class="rl"><a href="#who"><i class="fas fa-circle"></i> Who Must File?</a><a href="#benefits"><i class="fas fa-circle"></i> Benefits</a><a href="#process"><i class="fas fa-circle"></i> Filing Steps</a><a href="#pricing"><i class="fas fa-circle"></i> Pricing</a><a href="#faqs"><i class="fas fa-circle"></i> FAQs</a></nav></div>
...
function makeMiscPage(slug) {
  const url = `https://kambohassociates.com/blogs/${slug}`;
  const cityName = slugToTitle(slug.replace(/-city$/,'').replace(/-karachi$/,'').replace(/-sialkot$/,''));

  const cfgs = {
    'it-export-income-tax-pakistan':{ title:'IT Export Income Tax Pakistan 2026 | FBR Software Exports | Kamboh Associates',h1:'IT Export Income Tax in Pakistan — FBR Guide 2026',lead:'Pakistan IT exports benefit from a preferential tax regime under FBR. Software exports, IT-enabled services, and freelance income in foreign currency qualify for a 0.25% Final Tax Regime rate. Kamboh Associates helps IT companies and freelancers file FBR returns correctly and claim all available exemptions.',badge:'IT Export Tax Guide',icon:'fas fa-laptop-code',extra:'<h2 id="rates">IT Export Tax Rates 2026</h2><table class="dt"><thead><tr><th>Category</th><th>Tax Rate</th><th>Condition</th></tr></thead><tbody><tr><td>Software Export</td><td>0.25% FTR</td><td>On export receipts</td></tr><tr><td>IT-Enabled Services</td><td>0.25% FTR</td><td>Foreign currency income</td></tr><tr><td>Freelancer (Payoneer/Wise)</td><td>0.25% FTR</td><td>Foreign remittance</td></tr><tr><td>Local IT Services</td><td>Normal slab rates</td><td>PKR income</td></tr></tbody></table>'},
    'tax-consultant-fees-pakistan':{ title:'Tax Consultant Fees Pakistan 2026 | FBR Filing Cost | Kamboh Associates',h1:'Tax Consultant Fees in Pakistan 2026 — Complete Guide',lead:'Tax consultant fees in Pakistan vary based on service type, complexity, and consultant experience. Kamboh Associates offers transparent, affordable pricing starting from Rs 1,500 for NTN registration to Rs 3,500 for income tax returns. All prices include FBR filing and official acknowledgment — no hidden charges.',badge:'Tax Consultant Fees',icon:'fas fa-tags',extra:'<h2 id="fees">Tax Consultant Fees — Market vs Kamboh Associates</h2><table class="dt"><thead><tr><th>Service</th><th>Market Range</th><th>Kamboh Associates</th></tr></thead><tbody><tr><td>NTN Registration</td><td>Rs 1,500–5,000</td><td>Rs 1,500</td></tr><tr><td>Salaried Tax Return</td><td>Rs 3,500–10,000</td><td>Rs 3,500</td></tr><tr><td>Business Tax Return</td><td>Rs 7,000–25,000</td><td>Rs 7,000</td></tr><tr><td>Wealth Statement</td><td>Rs 5,000–15,000</td><td>Rs 5,000</td></tr><tr><td>Company Registration</td><td>Rs 8,000–30,000</td><td>Rs 8,000</td></tr></tbody></table>'},
    'tax-consultant-builders-developers-pakistan':{ title:'Tax Consultant for Builders & Developers Pakistan 2026 | Kamboh Associates',h1:'Tax Consultant for Builders & Developers in Pakistan — FBR 2026',lead:'Builders and property developers in Pakistan face complex FBR tax obligations including capital gains tax, advance tax under Section 236C/236K, and withholding tax compliance. Kamboh Associates provides specialized tax services for the real estate development sector across Pakistan.',badge:'Builders & Developers Tax',icon:'fas fa-building',extra:'<h2 id="taxes">Key Taxes for Builders & Developers</h2><table class="dt"><thead><tr><th>Tax Type</th><th>Rate</th><th>Applicable On</th></tr></thead><tbody><tr><td>Section 236C (Seller WHT)</td><td>2.75% filer / 5.5% non-filer</td><td>Property sale proceeds</td></tr><tr><td>Section 236K (Buyer WHT)</td><td>1.25% filer / 2.5% non-filer</td><td>Property purchase value</td></tr><tr><td>Capital Gains Tax</td><td>15% (open plot) / varies</td><td>Gain on sale</td></tr><tr><td>Advance Tax</td><td>Varies by project size</td><td>Developer income</td></tr></tbody></table>'},
    'tax-consultant-los-angeles-pakistanis':{ title:'Tax Consultant for Overseas Pakistanis in Los Angeles | FBR | Kamboh Associates',h1:'FBR Tax Services for Overseas Pakistanis in Los Angeles',lead:'Kamboh Associates provides complete FBR tax services for overseas Pakistanis living in Los Angeles. Income tax return filing, NTN registration, wealth statement, Section 8 Tax Clearance Certificate — all handled remotely via WhatsApp. No Pakistan visit required.',badge:'Overseas Pakistanis — Los Angeles',icon:'fas fa-globe',extra:'<h2 id="services">Services for Overseas Pakistanis</h2><ul><li><strong>Income Tax Return Filing</strong> — Annual FBR return even while abroad</li><li><strong>NTN Registration</strong> — Get your Pakistan tax number remotely</li><li><strong>Section 8 TCC</strong> — Tax Clearance Certificate for visa/NOC</li><li><strong>Wealth Statement</strong> — Overseas assets declared properly</li><li><strong>ATL Maintenance</strong> — Stay on Active Taxpayer List while abroad</li></ul>'},
    'tax-consultant-new-jersey-pakistanis':{ title:'Tax Consultant for Overseas Pakistanis in New Jersey | FBR | Kamboh Associates',h1:'FBR Tax Services for Overseas Pakistanis in New Jersey',lead:'Kamboh Associates provides complete FBR tax services for overseas Pakistanis living in New Jersey. Income tax return filing, NTN registration, wealth statement, Section 8 Tax Clearance Certificate — all handled remotely via WhatsApp. No Pakistan visit required.',badge:'Overseas Pakistanis — New Jersey',icon:'fas fa-globe',extra:'<h2 id="services">Services for Overseas Pakistanis</h2><ul><li><strong>Income Tax Return Filing</strong> — Annual FBR return even while abroad</li><li><strong>NTN Registration</strong> — Get your Pakistan tax number remotely</li><li><strong>Section 8 TCC</strong> — Tax Clearance Certificate for visa/NOC</li><li><strong>Wealth Statement</strong> — Overseas assets declared properly</li><li><strong>ATL Maintenance</strong> — Stay on Active Taxpayer List while abroad</li></ul>'},
    'paris-road-sialkot':{ title:'Tax Consultant Paris Road Sialkot | FBR Services | Kamboh Associates',h1:'Tax Consultant on Paris Road Sialkot — FBR Services 2026',lead:'Kamboh Associates provides complete FBR tax services to residents and businesses on Paris Road Sialkot and surrounding areas. Income tax return filing, NTN registration, wealth statement, FBR notice response — all handled remotely. WhatsApp 0328-4675162.',badge:'Paris Road Sialkot Tax Guide',icon:'fas fa-map-marker-alt',extra:'<h2 id="services">Tax Services Available</h2><ul><li><strong>Income Tax Return Filing</strong> — From Rs 3,500</li><li><strong>NTN Registration</strong> — 24–48 hours, Rs 1,500</li><li><strong>Wealth Statement</strong> — Accurate FBR-defensible statements</li><li><strong>FBR Notice Response</strong> — Professional, timely replies</li><li><strong>Company Registration</strong> — SECP and District Administration</li></ul>'}
  };

  const cfg = cfgs[slug] || {
    title:`Tax Consultant in ${cityName} | FBR Services | Kamboh Associates`,
    h1:`Expert Tax Consultant in ${cityName} — FBR Services 2026`,
    lead:`Kamboh Associates provides complete FBR tax services to residents and businesses in ${cityName}. Income tax return filing, NTN registration, wealth statement, FBR notice response — all handled remotely. WhatsApp 0328-4675162 for free consultation.`,
    badge:`${cityName} Tax Guide`,icon:'fas fa-map-marker-alt',
    extra:'<h2 id="services">Tax Services Available</h2><ul><li><strong>Income Tax Return Filing</strong> — From Rs 3,500</li><li><strong>NTN Registration</strong> — 24–48 hours, Rs 1,500</li><li><strong>Wealth Statement</strong> — Accurate FBR-defensible statements</li><li><strong>FBR Notice Response</strong> — Professional, timely replies</li><li><strong>Company Registration</strong> — SECP and District Administration</li></ul>'
  };
...
<meta name="description" content="${cfg.lead.substring(0,160)}"/>
<meta property="og:type" content="article"/><meta property="og:title" content="${cfg.h1}"/><meta property="og:url" content="${url}"/>
<link rel="canonical" href="${url}"/>
${HEAD_COMMON}
<script type="application/ld+json">[{"@context":"https://schema.org","@type":"Article","headline":"${cfg.h1.replace(/&/g,'&amp;')}","datePublished":"2026-07-17","author":{"@type":"Organization","name":"Kamboh Associates"}},{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://kambohassociates.com/"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://kambohassociates.com/blogs"},{"@type":"ListItem","position":3,"name":"${cfg.h1.replace(/&/g,'&amp;')}","item":"${url}"}]}]<\/script>
${CSS}
</head>
<body>
${NAV_HTML}
<section class="hero"><div class="container">
  <div class="breadcrumb"><a href="/"><i class="fas fa-home"></i> Home</a><i class="fas fa-chevron-right"></i><a href="/blogs">Blog</a><i class="fas fa-chevron-right"></i><span>${cfg.h1}</span></div>
  <div class="badge"><i class="${cfg.icon}"></i> ${cfg.badge}</div>
  <h1>${cfg.h1}</h1>
  <div class="hero-meta"><div class="meta-item"><i class="far fa-calendar-alt"></i> July 2026</div><div class="meta-item"><i class="fas fa-user-tie"></i> Kamboh Associates</div><div class="meta-item"><i class="far fa-clock"></i> 5 min read</div></div>
</div></section>
<div class="container"><div class="layout">
<article><div class="article reveal">
  ...
  <div class="cta-box">
    ...
    <div class="cta-btns">
      <a href="https://wa.me/923284675162?text=Hi%2C+I+need+tax+consultation" class="btn-w" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> Free Consultation</a>
      <a href="tel:03284675162" class="btn-g"><i class="fas fa-phone"></i> 0328-4675162</a>
    </div>
  </div>
  <h2 id="faqs">Frequently Asked Questions</h2>
  <div class="fq">
    ...
    <div class="fi"><div class="fq-q">What is the income tax return deadline? <i class="fas fa-plus"></i></div><div class="fq-a">The annual income tax return deadline is September 30. Late filing attracts a penalty of 5% of tax payable per month. File by August 31 to avoid issues.</div></div>
  </div>
</div></article>
<aside class="sidebar">
...
function processFile(filePath, generatorFn) {
  ...
  for (const line of lines) {
    ...
    fs.writeFileSync(outPath, generatorFn(slug), 'utf8');
    created++;
  }
}

const TMP = 'C:\\Users\\786\\AppData\\Local\\Temp\\gsc_404';
processFile(path.join(TMP,'tc_slugs.txt'), makeTCPage);
processFile(path.join(TMP,'ntn_slugs.txt'), makeNTNPage);
processFile(path.join(TMP,'itf_slugs.txt'), makeITFPage);
processFile(path.join(TMP,'misc_slugs.txt'), makeMiscPage);
